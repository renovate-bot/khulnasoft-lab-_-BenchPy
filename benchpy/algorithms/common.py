...
from benchpy.models.common import ModelConfig
from benchpy.utils import _read_yaml_config, DEVICE_TYPING
...
class Algorithm(ABC):
    ...
    def get_loss_and_updater(self, group: str) -> Tuple[LossModule, TargetNetUpdater]:
        ...
        This function calls the abstract :class:`~benchpy.algorithms.Algorithm._get_loss()` which needs to be implemented.
    ...
    def get_policy_for_loss(self, group: str) -> TensorDictModule:
        ...
        This function calls the abstract :class:`~benchpy.algorithms.Algorithm._get_policy_for_loss()` which needs to be implemented.
        The function will cache the output at the first call and return the cached values in future calls.
    ...
    def get_policy_for_collection(self) -> TensorDictSequential:
        ...
        This function calls the abstract :class:`~benchpy.algorithms.Algorithm._get_policy_for_collection()` which needs to be implemented.
        The function will cache the output at the first call and return the cached values in future calls.
    ...
    def get_parameters(self, group: str) -> Dict[str, Iterable]:
        ...
        This function calls the abstract :class:`~benchpy.algorithms.Algorithm._get_parameters()` which needs to be implemented.
    ...
    def get_from_yaml(cls, path: Optional[str] = None):
        ...
        Args:
            path (str, optional): The full path of the yaml file to load from.
                ...
                ``benchpy/conf/algorithm/self.associated_class().__name__``
