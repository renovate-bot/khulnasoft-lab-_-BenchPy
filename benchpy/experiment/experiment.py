...
from benchpy.experiment.callback import Callback, CallbackNotifier
from benchpy.experiment.logger import Logger
from benchpy.models.common import ModelConfig
from benchpy.utils import _read_yaml_config
...
class ExperimentConfig:
    ...
    To know their meaning, please check out the descriptions in ``benchpy/conf/experiment/base_experiment.yaml``
    """
    ...
    def get_from_yaml(path: Optional[str] = None):
        ...
        Args:
            path (str, optional): The full path of the yaml file to load from.
                ...
                ``benchpy/conf/experiment/base_experiment.yaml``

        Returns:
            the loaded :class:`~benchpy.experiment.ExperimentConfig`
        """
        if path is None:
            yaml_path = (
...
class Experiment(CallbackNotifier):
    """
    Main experiment class in BenchPy.
