...
def get_raw_dict_from_multirun_folder(multirun_folder: str) -> Dict:
    ...
    Examples:
        .. code-block:: python
            ...
            from benchpy.eval_results import get_raw_dict_from_multirun_folder, Plotting
...
if __name__ == "__main__":
    raw_dict = get_raw_dict_from_multirun_folder(
        multirun_folder="/Users/matbet/PycharmProjects/BenchPy/benchpy/multirun/2023-09-22/17-21-34"
    )
    processed_data = Plotting.process_data(raw_dict)
    (
        environment_comparison_matrix,
