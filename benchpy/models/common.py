...
from benchpy.utils import _class_from_name, _read_yaml_config, DEVICE_TYPING
...
class Model(TensorDictModuleBase, ABC):
    ...
    Models in BenchPy are instantiated per agent group.
...
class SequenceModel(Model):
    """A sequence of :class:`~benchpy.models.Model`
...
class ModelConfig(ABC):
    """
    Dataclass representing a :class:`~benchpy.models.Model` configuration.
    ...
    def get_from_yaml(cls, path: Optional[str] = None):
        ...
        Args:
            path (str, optional): The full path of the yaml file to load from.
                ...
                benchpy/conf/model/layers/self.associated_class().__name__
...
class SequenceModelConfig(ModelConfig):
    """Dataclass for a :class:`~benchpy.models.SequenceModel`.
    ...
    Examples:
          ...
          .. code-block:: python
            ...
            from benchpy.algorithms import IppoConfig
            from benchpy.environments import VmasTask
            from benchpy.experiment import Experiment, ExperimentConfig
            from benchpy.models import SequenceModelConfig, GnnConfig, MlpConfig
