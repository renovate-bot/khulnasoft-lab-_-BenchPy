...
from benchpy.utils import DEVICE_TYPING
...
class CustomEnvTask(Task):
    # Your task names.
    # Their config will be loaded from benchpy/conf/task/customenv

    TASK_1 = None  # Loaded automatically from benchpy/conf/task/customenv/task_1
    TASK_2 = None  # Loaded automatically from benchpy/conf/task/customenv/task_2
    ...
    @staticmethod
    def env_name() -> str:
        # The name of the environment in the benchpy/conf/task folder
        return "customenv"
